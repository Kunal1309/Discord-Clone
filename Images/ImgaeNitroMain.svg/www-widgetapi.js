...
t("Int8Array.prototype.fill",Na);t("Uint8Array.prototype.fill",Na);t("Uint8ClampedArray.prototype.fill",Na);t("Int16Array.prototype.fill",Na);t("Uint16Array.prototype.fill",Na);t("Int32Array.prototype.fill",Na);t("Uint32Array.prototype.fill",Na);t("Float32Array.prototype.fill",Na);t("Float64Array.prototype.fill",Na);t("Object.setPrototypeOf",function(a){return a||qa});
...
function rd(a,b,c,d,e,f){a.h||(a.h={});var g=a.h[c],h=md(a,c,3,d,f);if(!g){var k=h;g=[];var l=!!(H(a.v)&16);h=Pc(k);var m=k;!f&&h&&(k=Array.prototype.slice.call(k));for(var n=h,r=0;r<k.length;r++){var q=k[r];var w=b,z=!1;z=void 0===z?!1:z;q=Array.isArray(q)?new w(q):z?new w:void 0;if(void 0!==q){w=q.v;var D=z=H(w);h&&(D|=2);l&&(D|=16);D!=z&&Kc(w,D);w=D;n=n||!!(2&w);g.push(q)}}a.h[c]=g;b=k;k=!n;l=H(b);n=l|33;n=k?n|8:n&-9;l!=n&&(Object.isFrozen(b)&&(b=Array.prototype.slice.call(b)),Kc(b,n));k=b;m!==
k&&kd(a,c,k,d);(f||e&&h)&&Ic(g,2);e&&Object.freeze(g);return g}d=g;f||(Object.isFrozen(d)?e||(g=Array.prototype.slice.call(g),a.h[c]=g):e&&Object.freeze(d));return g}
...
function td(a,b,c,d,e){Yc(a);var f=null==d?Wc:Lc([]);if(null!=d){for(var g=!1,h=0;h<d.length;h++){var k=d[h];bd(k,b);g=g||Pc(k.v);f[h]=k.v}b=f;g=(g?0:8)|1;f=H(b);(f&g)!==g&&(Object.isFrozen(b)&&(b=Array.prototype.slice.call(b)),Kc(b,f|g));f=b;a.h||(a.h={});a.h[c]=d}else a.h&&(a.h[c]=void 0);return kd(a,c,f,e)}
...
function Ed(a,b){b.ja&&(a.ja=b.ja.slice());var c=b.h;if(c){b=b.I;for(var d in c){var e=c[d];if(e){var f=!(!b||!b[d]),g=+d;if(Array.isArray(e)){if(e.length){var h=a,k=e[0].constructor,l=Pc(h.v);k=rd(h,k,g,f,l,l);f=md(h,g,3,f,l);if(!(l||H(f)&8)){for(l=0;l<k.length;l++)g=k[l],h=qd(g),g!==h&&(k[l]=h,f[l]=h.v);Ic(f,8)}for(l=0;l<Math.min(k.length,e.length);l++)Ed(k[l],e[l])}}else throw Error("unexpected object: type: "+Oa(e)+": "+e);}}}}
...
;var Wf=A.JSON.stringify;function tg(){var a=this;this.promise=new Promise(function(b,c){a.resolve=b;a.reject=c})}
...
case 6:throw new Gj(m,l);case 5:return z.return(h);case 2:n=ya(z);if(n instanceof DOMException?"VersionError"!==n.name:"DOMError"in self&&n instanceof DOMError?"VersionError"!==n.name:!(n instanceof Object&&"message"in n)||"An attempt was made to open a database using a lower version than the existing version."!==n.message){z.s(10);break}return x(z,a.j(a.name,void 0,Object.assign({},d,{upgrade:void 0})),11);case 11:r=z.i;q=r.h.version;if(void 0!==a.options.version&&q>a.options.version+1)throw r.close(),
...
wa(e,2);d={actualName:"yt-idb-test-do-not-use",publicName:"yt-idb-test-do-not-use",userIdentifier:void 0};return x(e,jl(d,ol),4);case 4:return x(e,kl("yt-idb-test-do-not-use",ol),5);case 5:return e.return(!0);case 2:return ya(e),e.return(!1)}})}
...
;new tg;function tl(a){if(!pj())throw a=new T("AUTH_INVALID",{dbName:a}),wj(a),a;var b=qj();return{actualName:a+":"+b,publicName:a,userIdentifier:b}}
function ul(a,b,c,d){var e,f,g,h,k,l;return y(function(m){switch(m.h){case 1:return f=null!=(e=Error().stack)?e:"",x(m,sl(),2);case 2:g=m.i;if(!g)throw h=Kj("openDbImpl",a,b),R("ytidb_async_stack_killswitch")||(h.stack=h.stack+"\n"+f.substring(f.indexOf("\n")+1)),wj(h),h;yj(a);k=c?{actualName:a,publicName:a,userIdentifier:void 0}:tl(a);wa(m,3);return x(m,jl(k,g),5);case 5:return x(m,bl(k.actualName,b,d),6);case 6:return m.return(m.i);case 3:return l=ya(m),wa(m,7),x(m,kl(k.actualName,g),9);case 9:xa(m,
...
function Xl(a){var b=new th,c=new kh;I(c,1,a.Xa);I(c,2,a.Wa);I(c,16,a.ub);I(c,17,a.Va);if(a.Ia){var d=a.Ia,e=new gh;d.coldConfigData&&I(e,1,d.coldConfigData);d.appInstallData&&I(e,6,d.appInstallData);d.coldHashData&&I(e,3,d.coldHashData);d.hotHashData&&I(e,5,d.hotHashData);J(c,gh,62,e)}if((d=A.devicePixelRatio)&&1!=d){if(null!=d&&"number"!==typeof d)throw Error("Value of float field must be a number|null|undefined, found "+typeof d+": "+d);I(c,65,d)}d=P("EXPERIMENTS_TOKEN","");""!==d&&I(c,54,d);d=
ei();if(0<d.length){e=new mh;for(var f=0;f<d.length;f++){var g=new eh;I(g,1,d[f].key);nd(g,2,fh,d[f].value);ud(e,15,eh,g)}J(b,mh,5,e)}Rl(a,c);R("enable_third_party_info")&&Sl(b);Tl(c);Ul(a,c);Vl(c);R("start_sending_config_hash")&&Wl(c);P("DELEGATED_SESSION_ID")&&!R("pageid_as_header_web")&&(a=new rh,I(a,3,P("DELEGATED_SESSION_ID")));a=u(Object.entries(wi(P("DEVICE",""))));for(d=a.next();!d.done;d=a.next())e=u(d.value),d=e.next().value,e=e.next().value,"cbrand"===d?I(c,12,e):"cmodel"===d?I(c,13,e):
"cbr"===d?I(c,87,e):"cbrver"===d?I(c,88,e):"cos"===d?I(c,18,e):"cosver"===d?I(c,19,e):"cplatform"===d&&I(c,42,e);J(b,kh,1,c);return b}
...
;var Pm;function Qm(){var a=fm.call;Pm||(Pm=new Nm({dc:!0,cc:!0}));a.call(fm,this,{D:{nb:ym,ba:xm,Ta:um,zb:vm,Na:wm,set:sm},F:Pm,handleError:ai,da:bi,S:Rm,now:U,hb:Lm,K:nj(),Ma:"publicytnetworkstatus-online",La:"publicytnetworkstatus-offline",wa:!0,va:.1,Ba:di("potential_esf_error_limit",10),A:R,ia:!(pj()&&"www.youtube-nocookie.com"!==Rb(document.location.toString()))});this.j=new tg;R("networkless_immediately_drop_all_requests")&&zm();Al("LogsDatabaseV2")}
...
K=w.stack||r.i||"Not available";if(K.startsWith(D+": "+z)){var M=K.split("\n");M.shift();K=M.join("\n")}var O=w.lineNumber||"Not available",ob=w.fileName||"Not available",tc=K,za=0;if(r.hasOwnProperty("args")&&r.args&&r.args.length)for(var ra=0;ra<r.args.length&&!(za=$i(r.args[ra],"params."+ra,q,za),500<=za);ra++);else if(r.hasOwnProperty("params")&&r.params){var X=r.params;if("object"===typeof r.params)for(n in X){if(X[n]){var ca="params."+n,da=bj(X[n]);q[ca]=da;za+=ca.length+da.length;if(500<za)break}}else q.params=
bj(X)}if(oo.length)for(var W=0;W<oo.length&&!(za=$i(oo[W],"params.context."+W,q,za),500<=za);W++);navigator.vendor&&!q.hasOwnProperty("vendor")&&(q["device.vendor"]=navigator.vendor);var S={message:z,name:D,lineNumber:O,fileName:ob,stack:tc,params:q,sampleWeight:1},bk=Number(r.columnNumber);isNaN(bk)||(S.lineNumber=S.lineNumber+":"+bk);if("IGNORED"===r.level)m=0;else a:{for(var ck=Wi(),dk=u(ck.U),Xf=dk.next();!Xf.done;Xf=dk.next()){var ek=Xf.value;if(S.message&&S.message.match(ek.ec)){m=ek.weight;
break a}}for(var fk=u(ck.T),Yf=fk.next();!Yf.done;Yf=fk.next()){var gk=Yf.value;if(gk.mb(S)){m=gk.weight;break a}}m=1}S.sampleWeight=m;for(var hk=u(Ri),Zf=hk.next();!Zf.done;Zf=hk.next()){var $f=Zf.value;if($f.Aa[S.name])for(var ik=u($f.Aa[S.name]),ag=ik.next();!ag.done;ag=ik.next()){var jk=ag.value,Vd=S.message.match(jk.regexp);if(Vd){S.params["params.error.original"]=Vd[0];for(var bg=jk.groups,kk={},Vb=0;Vb<bg.length;Vb++)kk[bg[Vb]]=Vd[Vb+1],S.params["params.error."+bg[Vb]]=Vd[Vb+1];S.message=$f.Ka(kk);
...
ua);if(R("record_app_crashed_web")&&0===no&&1===ua.sampleWeight)if(no++,R("errors_via_jspb")){var cg=new Hh;I(cg,1,1);if(!R("report_client_error_with_app_crash_ks")){var mk=new Ch;I(mk,1,ua.message);var nk=new Dh;J(nk,Ch,3,mk);var ok=new Eh;J(ok,Dh,5,nk);var pk=new Fh;J(pk,Eh,9,ok);J(cg,Fh,4,pk)}var Ro=cg,qk=new Kh;sd(qk,Hh,20,Lh,Ro);jo(qk)}else{var rk={appCrashType:"APP_CRASH_TYPE_BREAKPAD"};R("report_client_error_with_app_crash_ks")||(rk.systemHealth={crashData:{clientError:{logMessage:{message:ua.message}}}});
ho("appCrashed",rk)}mo++}else"WARNING"===h&&Xi.fa("handleWarning",ua);if(R("kevlar_gel_error_routing"))a:{var dg=void 0,eg=void 0,Mc=h,Q=ua;if(R("errors_via_jspb")){if(qo())eg=void 0;else{var Wb=new zh;I(Wb,1,Q.stack);Q.fileName&&I(Wb,4,Q.fileName);var La=Q.lineNumber&&Q.lineNumber.split?Q.lineNumber.split(":"):[];0!==La.length&&(1!==La.length||isNaN(Number(La[0]))?2!==La.length||isNaN(Number(La[0]))||isNaN(Number(La[1]))||(I(Wb,2,Number(La[0])),I(Wb,3,Number(La[1]))):I(Wb,2,Number(La[0])));var vb=
new Ch;I(vb,1,Q.message);I(vb,3,Q.name);I(vb,6,Q.sampleWeight);"ERROR"===Mc?I(vb,2,2):"WARNING"===Mc?I(vb,2,1):I(vb,2,0);var fg=new Ah;I(fg,1,!0);sd(fg,zh,3,Bh,Wb);var wb=new wh;I(wb,3,window.location.href);for(var sk=P("FEXP_EXPERIMENTS",[]),gg=0;gg<sk.length;gg++){var tk=wb,So=sk[gg];Yc(tk);md(tk,5,2,!1,!1).push(So)}var hg=Wh();if(!Xh()&&hg)for(var uk=u(Object.keys(hg)),xb=uk.next();!xb.done;xb=uk.next()){var vk=xb.value,ig=new yh;I(ig,1,vk);I(ig,2,String(hg[vk]));ud(wb,4,yh,ig)}var jg=Q.params;
if(jg){var wk=u(Object.keys(jg));for(xb=wk.next();!xb.done;xb=wk.next()){var xk=xb.value,kg=new yh;I(kg,1,"client."+xk);I(kg,2,String(jg[xk]));ud(wb,4,yh,kg)}}var yk=P("SERVER_NAME"),zk=P("SERVER_VERSION");if(yk&&zk){var lg=new yh;I(lg,1,"server.name");I(lg,2,yk);ud(wb,4,yh,lg);var mg=new yh;I(mg,1,"server.version");I(mg,2,zk);ud(wb,4,yh,mg)}var Wd=new Dh;J(Wd,wh,1,wb);J(Wd,Ah,2,fg);J(Wd,Ch,3,vb);eg=Wd}var Ak=eg;if(!Ak)break a;var Bk=new Kh;sd(Bk,Dh,163,Lh,Ak);jo(Bk)}else{if(qo())dg=void 0;else{var Nc=
{stackTrace:Q.stack};Q.fileName&&(Nc.filename=Q.fileName);var Ma=Q.lineNumber&&Q.lineNumber.split?Q.lineNumber.split(":"):[];0!==Ma.length&&(1!==Ma.length||isNaN(Number(Ma[0]))?2!==Ma.length||isNaN(Number(Ma[0]))||isNaN(Number(Ma[1]))||(Nc.lineNumber=Number(Ma[0]),Nc.columnNumber=Number(Ma[1])):Nc.lineNumber=Number(Ma[0]));var ng={level:"ERROR_LEVEL_UNKNOWN",message:Q.message,errorClassName:Q.name,sampleWeight:Q.sampleWeight};"ERROR"===Mc?ng.level="ERROR_LEVEL_ERROR":"WARNING"===Mc&&(ng.level="ERROR_LEVEL_WARNNING");
var To={isObfuscated:!0,browserStackInfo:Nc},Xb={pageUrl:window.location.href,kvPairs:[]};P("FEXP_EXPERIMENTS")&&(Xb.experimentIds=P("FEXP_EXPERIMENTS"));var og=Wh();if(!Xh()&&og)for(var Ck=u(Object.keys(og)),yb=Ck.next();!yb.done;yb=Ck.next()){var Dk=yb.value;Xb.kvPairs.push({key:Dk,value:String(og[Dk])})}var pg=Q.params;if(pg){var Ek=u(Object.keys(pg));for(yb=Ek.next();!yb.done;yb=Ek.next()){var Fk=yb.value;Xb.kvPairs.push({key:"client."+Fk,value:String(pg[Fk])})}}var Gk=P("SERVER_NAME"),Hk=P("SERVER_VERSION");
Gk&&Hk&&(Xb.kvPairs.push({key:"server.name",value:Gk}),Xb.kvPairs.push({key:"server.version",value:Hk}));dg={errorMetadata:Xb,stackTrace:To,logMessage:ng}}var Ik=dg;if(!Ik)break a;ho("clientError",Ik)}if("ERROR"===Mc||R("errors_flush_gel_always_killswitch"))b:{if(R("web_fp_via_jspb")&&(eo(!0),!R("web_fp_via_jspb_and_json")))break b;eo()}}if(!R("suppress_error_204_logging")){var zb=ua,Oc=zb.params||{},$a={urlParams:{a:"logerror",t:"jserror",type:zb.name,msg:zb.message.substr(0,250),line:zb.lineNumber,
level:h,"client.name":Oc.name},postParams:{url:P("PAGE_NAME",window.location.href),file:zb.fileName},method:"POST"};Oc.version&&($a["client.version"]=Oc.version);if($a.postParams){zb.stack&&($a.postParams.stack=zb.stack);for(var Jk=u(Object.keys(Oc)),qg=Jk.next();!qg.done;qg=Jk.next()){var Kk=qg.value;$a.postParams["client."+Kk]=Oc[Kk]}var rg=Wh();if(rg)for(var Lk=u(Object.keys(rg)),sg=Lk.next();!sg.done;sg=Lk.next()){var Mk=sg.value;$a.postParams[Mk]=rg[Mk]}var Nk=P("SERVER_NAME"),Ok=P("SERVER_VERSION");
